...
from litreview.forms import DeleteFollowForm, ReviewForm, TicketForm, DeleteTicketForm, FollowUsersForm
...
def review_from_scratch(request):
    ...
    return render(
                  request,
                  'litreview/review_from_scratch.html',
